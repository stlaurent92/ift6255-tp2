 ...
 * @since 3.0
 */
public class ModifiedDirichletLM extends WeightingModel {
	...
	public double score(double tf, double docLength) {
		...
		double boost = 1.0d;
		double score = boost * (WeightingModelLibrary.log(1 + (tf/(c * (super.termFrequency / numberOfTokens))) ) + WeightingModelLibrary.log(c/(docLength+c)));
